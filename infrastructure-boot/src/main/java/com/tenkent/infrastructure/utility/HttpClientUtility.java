...
public class HttpClientUtility {
    ...
    public static String sendPost(String url, String param, String charset, String contentType) {
        LoggerManager.info(HttpClientUtility.class,
            "START sendPost... url:{}, param:{}, charset:{}, contentType:{}",
            url,
            param,
            charset,
            contentType);
        ...
        try {
            ...
            LoggerManager
                .info(HttpClientUtility.class, "END sendPost...success, url:{}, param:{}, result:{}", url, param, result);
            return result;
        }
        catch (Exception e) {
            LoggerManager.error(HttpClientUtility.class,
                e,
                "invoke interface FAILED, url:{}, param:{}, charset:{}",
                url,
                param,
                charset,
                result);
